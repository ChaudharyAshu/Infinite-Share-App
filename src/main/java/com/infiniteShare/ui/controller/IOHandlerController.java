...
import com.infiniteShare.service.IOHandlerService;
import com.infiniteShare.shared.constants.urlConstants.ControllerPaths;
import com.infiniteShare.shared.constants.urlConstants.actionPaths.IO_HandlerPaths;
import com.infiniteShare.ui.model.response.DownloadLinkDataViewModel;
...
public class IOHandlerController {
    ...
    public void zipDownload(@PathVariable String[] fileNames, HttpServletResponse response) throws IOException {
        String downloadFileName = "Infinite Share Download.zip";
